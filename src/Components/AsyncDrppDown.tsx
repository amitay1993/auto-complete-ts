...
import {Container,CountryList, CountryListItem, Search} from "../Styles/DrowDownStyles";
...
export const AsyncDropDown: React.FC<Props> =  ({loadOptions,value:selectedItem,onChange:setSelectedItem,renderInput}:Props) => {
    ...
    const showCountries = () => {
        //TODO: check about countries type.
        return countries?.map((country:any, idx:number) => {
            return (
                <CountryListItem
